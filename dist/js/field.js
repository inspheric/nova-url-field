...
Nova.booting(function (Vue, router) {
    Vue.component('index-url-field', __webpack_require__(4));
    Vue.component('detail-url-field', __webpack_require__(9));
    Vue.component('form-url-field', __webpack_require__(12));
});
...
var render = function() {
  ...
  return _c("div", [
    _vm.hasCustomHtml && _vm.clickable
      ? _c("a", {
          staticClass: "cursor-pointer no-underline text-90",
          attrs: {
            href: _vm.field.value,
            title: _vm.field.title || _vm.field.value,
            target: _vm.field.sameTab ? "_self" : "_blank",
            rel: _vm.field.rel
          },
          domProps: { innerHTML: _vm._s(_vm.field.customHtml) }
        })
      : _vm.hasCustomHtml && !_vm.clickable
      ? _c("div", { domProps: { innerHTML: _vm._s(_vm.field.customHtml) } })
      : _vm.field.value && _vm.clickable
      ? _c(
          "a",
          {
            staticClass:
              "cursor-pointer dim no-underline text-primary flex items-center",
            attrs: {
              href: _vm.field.value,
              title: _vm.field.title || _vm.field.value,
              target: _vm.field.sameTab ? "_self" : "_blank",
          ...
          [
            _c(
              "svg",
              {
                staticClass: "fill-current mr-2 flex-no-shrink",
                attrs: {
            ...
            _vm._v(" "),
            _vm.shouldDisplayAsHtml && _vm.field.label
              ? _c("span", {
                  staticClass: "block",
              ...
              : _c("span", { staticClass: "block truncate" }, [
                  _vm._v(
                    "\n            " +
                      _vm._s(
                        _vm.field.label ? _vm.field.label : _vm.field.value
                      ) +
                      "\n        "
                  )
                ])
